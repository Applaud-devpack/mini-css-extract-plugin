<div align="center">
  ...
  <h1>@applaud/mini-css-extract-plugin</h1>
</div>
...
```bash
npm install --save-dev @applaud/mini-css-extract-plugin
```
...
```js
const MiniCssExtractPlugin = require("@applaud/mini-css-extract-plugin");
module.exports = {
  plugins: [
